...
def sistema_de_compras(itens_disponiveis, historico_compras, usuario=None, usuario_guest=None):
    carrinho = []
...
def main():
    ...
    usuario = login2()
    if usuario is None:
        id_guest = usuario_guest()
        print(f"Bem-vindo, seu numero é {id_guest}.")
        sistema_de_compras(itens_disponiveis, historico_compras, usuario_guest=f"Guest {usuario_guest}")
    else:
        print(f"Bem-vindo {usuario}.")
        sistema_de_compras(itens_disponiveis, historico_compras, usuario=usuario)
